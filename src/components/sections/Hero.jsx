        ...
        <RevealOnScroll>
            <div className="text-center z-10 px-4">
                <h1 className='text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-red-500 to-orange-500  bg-clip-text text-transparent leading-tight'>
                    Welcome to ScorcheNet
                </h1>
                <p className='text-gray-400 text-lg mb-8 max-w-lg mx-auto'>
                    ScorcheNet Powered by ScorcheTech offers fast, secure, and affordable digital services. Join a community that values innovation and accessibility.
                </p>
